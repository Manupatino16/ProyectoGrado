								...
								<li><a href="contact.php">Contacto</a></li>
								 <li class="dropdown fuentetexto"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Aplicativo <span class="caret"></span></a>
          						<ul class="dropdown-menu">
            						...
            						<li><a href="indexenglish.php">traductor</a></li>
          						</ul>
        						</li>
								<div class="clear"></div>
							</ul>
		...
		<div class="container">
			<div class="row content_bottom-text">
			  <div class="col-md-7">
				...
				<h3>Visión</h3>
				<p class="m_1"> Concientizar a los habitantes del municipio de los derechos de los animales, de la importancia de protegerlos y de cuidarlos, Inspirar a ser mejores personas con difusión y sensibilización. Darles un hogar con mejor calidad de vida que lleve respeto y responsabilidad hacia los animales.</p>
			  </div>
			</div>
		</div>
	</div>
