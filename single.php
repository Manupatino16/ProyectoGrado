				...
				<div class="col-md-9 single_left">
				   <div class="single_image">
				        ...
				        <div class="single_right">
				        	<h3><b>REQUISITOS DE ADOPCIÓN</h3>
				        	<p class="m_8"><br><b>-Firmar compromiso de tendencia responsable.</b><br/></p>
				        	<p class="m_8"><br><b>-Fotocopia de la cédula.</b><br/></p>
				            <p class="m_8"><br><b>-Referencia personal.</b><br/></p>
				            <p class="m_8"><br><b>-Identificar al animal por medio del microchip.</b><br/></p>
				        </div>
			        </div>	
	            </div>
	        </div>
